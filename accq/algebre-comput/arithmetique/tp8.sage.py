...
# This file was *autogenerated* from the file tp8.sage
from sage.all_cmdline import *   # import sage library

_sage_const_561 = Integer(561); _sage_const_0 = Integer(0); _sage_const_1 = Integer(1); _sage_const_2 = Integer(2); _sage_const_10 = Integer(10); _sage_const_500 = Integer(500); _sage_const_100 = Integer(100); _sage_const_20 = Integer(20); _sage_const_3 = Integer(3); _sage_const_1001 = Integer(1001); _sage_const_100000 = Integer(100000); _sage_const_150 = Integer(150); _sage_const_4 = Integer(4); _sage_const_10000 = Integer(10000); _sage_const_9 = Integer(9); _sage_const_1000 = Integer(1000); _sage_const_5 = Integer(5)
print("""\
# *************************************************************************** #
# *************************************************************************** #
...
def testRM(n) :
    ...
    '''
    a = random.randint(_sage_const_2 , n-_sage_const_1 )
    v, m = val_padique(_sage_const_2 , n-_sage_const_1 )
...
def testSS(n):
    ...
    if power_mod(a, (n-_sage_const_1 )//_sage_const_2 , n) == v :
        return true 
    return false
...
def testL(n, p, q):
    D = p*p-_sage_const_4 *q 
    g = gcd(n, _sage_const_2 *q*D)
    ...
    m = x
    t = _sage_const_0 
    while m>_sage_const_0  and m % _sage_const_2  == _sage_const_0  :
        m //= _sage_const_2 
        t += _sage_const_1 
    u, v = [_sage_const_0 , _sage_const_1 ], [_sage_const_2 , p]
    for i in range (_sage_const_2 , x+_sage_const_1 ) :
        u.append(p*u[-_sage_const_1 ]-q*u[-_sage_const_2 ])
        v.append(p*v[-_sage_const_1 ]-q*v[-_sage_const_2 ])
    g = gcd(n, u[m])
    if _sage_const_1 <g<n :
        return false 
    if g == n :
...
for _ in range(_sage_const_10 ):
    n = ZZ.random_element(_sage_const_2 ,_sage_const_10000 )
...
def testBPSW(n):
    if n == _sage_const_2  :
        return true
    if testRM_temoin(_sage_const_2 , n) == false :
        return false 
    k, D = _sage_const_0 , _sage_const_5 
    while jacobi_symbol(D, n) != -_sage_const_1  :
        k += _sage_const_1 
        D = (-_sage_const_1 )**k * (_sage_const_2 *k+_sage_const_5 )
    p, q = _sage_const_1 , (_sage_const_1 -D)/_sage_const_4 
