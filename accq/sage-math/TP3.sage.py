...
# This file was *autogenerated* from the file TP3.sage
from sage.all_cmdline import *   # import sage library

_sage_const_2 = Integer(2); _sage_const_3 = Integer(3); _sage_const_4 = Integer(4); _sage_const_53 = Integer(53); _sage_const_19 = Integer(19); _sage_const_18 = Integer(18); _sage_const_8 = Integer(8); _sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_5 = Integer(5); _sage_const_50 = Integer(50); _sage_const_239 = Integer(239); _sage_const_1e18 = RealNumber('1e18'); _sage_const_2p5468182768840820791359975088097915 = RealNumber('2.5468182768840820791359975088097915'); _sage_const_9 = Integer(9); _sage_const_25 = Integer(25); _sage_const_14 = Integer(14); _sage_const_11 = Integer(11); _sage_const_47 = Integer(47); _sage_const_17 = Integer(17); _sage_const_32 = Integer(32)
print("""\
# *************************************************************************** #
# *************************************************************************** #
...
A = matrix(ZZ,[
        [ _sage_const_2 , -_sage_const_3 ,  _sage_const_4 ],
        [ _sage_const_4 ,  _sage_const_4 , _sage_const_53 ]])

# Par calculs à la main, on trouve des vecteurs solutions particulières de l'équation :
v1 = vector([_sage_const_19 , _sage_const_18 , _sage_const_4 ])
v2 = vector([-_sage_const_8 , -_sage_const_4 , _sage_const_1 ])

p1 = A*v1
assert (p1[_sage_const_0 ] == _sage_const_0  and p1[_sage_const_1 ] % _sage_const_5  == _sage_const_0 )

p2 = A*v2
assert (p2[_sage_const_0 ] == _sage_const_0  and p2[_sage_const_1 ] % _sage_const_5  == _sage_const_0 )
...
r = _sage_const_3 
B = zero_matrix(ZZ, r+_sage_const_1 , r)
for i in range (r) :
    B[i, i] = _sage_const_1 
for j in range (r) :
...
alpha=[B[_sage_const_0 , i] for i in range (_sage_const_3 )]
...
M = _sage_const_1e18 
m = _sage_const_4 
B = zero_matrix(ZZ, m+_sage_const_1 , m)
for i in range (m) :
    B[i, i] = _sage_const_1 
for j in range (m) :
    B[m, j] = round(M*(r**j))
...
A = matrix(ZZ, [[_sage_const_47 , _sage_const_17 ], [_sage_const_32 , _sage_const_14 ]])

def lovasz_condition(b) :
    n = b.ncols()
    for i0 in range (n-_sage_const_1 ) :
        if (b[:,i0].norm())**_sage_const_2  > _sage_const_2 *(b[:,i0+_sage_const_1 ].norm())**_sage_const_2  :
            return i0
...
def myLLL(M):
    ...
    while repeter : 
        ...
        if i0 >= _sage_const_0  :
            B[:,i0], B[:,i0+_sage_const_1 ] = B[:,i0+_sage_const_1 ], B[:,i0]
        else :
            repeter = False
...
An = zero_matrix(ZZ,n, n+_sage_const_1 )
for i in range (n) :
    An[i, _sage_const_0 ] = _sage_const_1 
    An[i, i+_sage_const_1 ] = -_sage_const_1 
G_An, an = Gram(An)

Dn = zero_matrix(ZZ,n,n)
for i in range (n-_sage_const_1 ) :
    Dn[i, _sage_const_0 ] = _sage_const_1 
    Dn[i, i+_sage_const_1 ] = _sage_const_1 
Dn[n-_sage_const_1 , _sage_const_0 ] = _sage_const_2 
G_Dn, dn = Gram(Dn)


E8 = matrix(QQ,n, n)
E8[_sage_const_0 , _sage_const_0 ] = _sage_const_2 
for i in range (_sage_const_1 , n-_sage_const_1 ) :
    E8[i, _sage_const_0 ] = _sage_const_1 
    E8[i, i+_sage_const_1 ] = _sage_const_1 
for j in range (n) :
    E8[n-_sage_const_1 , j] = QQ(_sage_const_1 /_sage_const_2 )
G_E8, e8 = Gram(E8)
...
def min_det(A) :
    ...
    #print(A)
    lambda1L = A[_sage_const_0 ].norm()
    return lambda1L, detL

def densite(A, n) :
    lambda1L, detL = min_det(A)
    # print(detL)
    ans = pi**(n/_sage_const_2 )/(gamma((n/_sage_const_2 )+_sage_const_1 )*(_sage_const_2 **n)) * ((lambda1L**n)/(detL.sqrt()))
    return ans.n()

A2_base = matrix(ZZ, [[_sage_const_1 , -_sage_const_1 , _sage_const_0 ], [_sage_const_1 , _sage_const_0 , -_sage_const_1 ]])
A3_base = matrix(ZZ, [[_sage_const_1 , -_sage_const_1 , _sage_const_0 , _sage_const_0 ], [_sage_const_1 , _sage_const_0 , -_sage_const_1 , _sage_const_0 ], [_sage_const_1 , _sage_const_0 , _sage_const_0 , -_sage_const_1 ]])
D4_base = matrix(ZZ, [[_sage_const_1 , _sage_const_1 , _sage_const_0 , _sage_const_0 ], [_sage_const_0 , _sage_const_1 , _sage_const_1 , _sage_const_0 ], [_sage_const_0 , _sage_const_0 , _sage_const_1 , _sage_const_1 ], [_sage_const_2 , _sage_const_0 , _sage_const_0 , _sage_const_0 ]])
D5_base = matrix(ZZ, [
    [_sage_const_1 , _sage_const_1 , _sage_const_0 , _sage_const_0 , _sage_const_0 ], 
    [_sage_const_0 , _sage_const_1 , _sage_const_1 , _sage_const_0 , _sage_const_0 ], 
    [_sage_const_0 , _sage_const_0 , _sage_const_1 , _sage_const_1 , _sage_const_0 ], 
    [_sage_const_0 , _sage_const_0 , _sage_const_0 , _sage_const_1 , _sage_const_1 ],
    [_sage_const_2 , _sage_const_0 , _sage_const_0 , _sage_const_0 , _sage_const_0 ]
])
n = _sage_const_8 
E8_base = matrix(QQ,n, n)
E8_base[_sage_const_0 , _sage_const_0 ] = _sage_const_2 
for i in range (_sage_const_1 , n-_sage_const_1 ) :
    E8_base[i, _sage_const_0 ] = _sage_const_1 
    E8_base[i, i+_sage_const_1 ] = _sage_const_1 
for j in range (n) :
    E8_base[n-_sage_const_1 , j] = QQ(_sage_const_1 /_sage_const_2 )


a2 = densite(A2_base, _sage_const_2 )
a3 = densite(A3_base, _sage_const_3 )
d4 = densite(D4_base, _sage_const_4 )
d5 = densite(D5_base, _sage_const_5 )
e8 = densite(E8_base, _sage_const_8 )
